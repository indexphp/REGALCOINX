...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About REGALCOIN", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>REGALCOIN</b> version", 0));
...
"Copyright \302\251 2014 The REGALCOIN developers", 0));
