...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 DRM"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 DRM"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 DRM"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 DRM"));
