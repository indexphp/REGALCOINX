...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "REGALCOIN - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "<html><head/><body><p><a href=\"https://REGALCOIN.co/\"><span style=\" text-decoration: underline; color:#0000ff;\">Regalcoin Core</span></a></p></body></html>", 0));
        ...
        label_10->setText(QApplication::translate("RPCConsole", "<html><head/><body><p><a href=\"https://regalcoin.info/\"><span style=\" text-decoration: underline; color:#0000ff;\">Block chain</span></a></p></body></html>", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the REGALCOIN debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the REGALCOIN-Qt help message to get a list with possible REGALCOIN command-line options.", 0));
#endif // QT_NO_TOOLTIP
